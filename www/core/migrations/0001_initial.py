# Generated by Django 3.2.12 on 2022-09-24 17:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data', models.FileField(upload_to='', verbose_name='Excel data')),
            ],
        ),
        migrations.CreateModel(
            name='Interest',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lat', models.DecimalField(decimal_places=15, max_digits=20, verbose_name='Lattitude')),
                ('lng', models.DecimalField(decimal_places=15, max_digits=20, verbose_name='Longitude')),
                ('alt', models.DecimalField(decimal_places=15, max_digits=20, verbose_name='Altitude')),
                ('identifier', models.CharField(blank=True, max_length=50, null=True, verbose_name='Identifier')),
                ...
                ('horizontal_accuracy', models.DecimalField(decimal_places=15, max_digits=20, verbose_name='Horizontal Accuracy')),
                ('vertical_accuracy', models.DecimalField(decimal_places=15, max_digits=20, verbose_name='Vertical Accuracy')),
                ('confidence', models.DecimalField(decimal_places=15, max_digits=20, verbose_name='Confidence')),
                ('activity', models.CharField(choices=[('Walking', 'Walking'), ('Running', 'Running'), ('Cycling', 'Cycling'), ('Driving', 'Driving'), ('Unknown', 'Unknown')], default='Unknown', max_length=10, verbose_name='Activity')),
